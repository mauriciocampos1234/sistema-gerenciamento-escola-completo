...
{
    public class AlunoTurmaBoletimSqlServerRepository : BaseRepository, IAlunoTurmaBoletimRepository
    {
        public AlunoTurmaBoletimSqlServerRepository(string connectionString) : base(connectionString) { }
        ...
        public int? Inserir(AlunoTurmaBoletim alunoTurmaBoletim)
        {
            ...
            using (var conn = new SqlConnection(ConnectionString))
            {
                ...
                cmd.Parameters.AddWithValue("@nota_bim1_escrita", alunoTurmaBoletim.NotaBim1Escrita ?? (object)DBNull.Value);
                cmd.Parameters.AddWithValue("@nota_bim1_leitura", alunoTurmaBoletim.NotaBim1Leitura ?? (object)DBNull.Value);
                cmd.Parameters.AddWithValue("@nota_bim1_conversacao", alunoTurmaBoletim.NotaBim1Conversacao ?? (object)DBNull.Value);
                cmd.Parameters.AddWithValue("@nota_bim1_final", alunoTurmaBoletim.NotaBim1Final ?? (object)DBNull.Value);
                cmd.Parameters.AddWithValue("@nota_bim2_leitura", alunoTurmaBoletim.NotaBim2Leitura ?? (object)DBNull.Value);
                cmd.Parameters.AddWithValue("@nota_bim2_escrita", alunoTurmaBoletim.NotaBim2Escrita ?? (object)DBNull.Value);
                cmd.Parameters.AddWithValue("@nota_bim2_conversacao", alunoTurmaBoletim.NotaBim2Conversacao ?? (object)DBNull.Value);
                cmd.Parameters.AddWithValue("@nota_bim2_final", alunoTurmaBoletim.NotaBim2Final ?? (object)DBNull.Value);
                cmd.Parameters.AddWithValue("@nota_final_semestre", alunoTurmaBoletim.NotaFinalSemestre ?? (object)DBNull.Value);
                cmd.Parameters.AddWithValue("@faltas_semestre", alunoTurmaBoletim.FaltasSemestre ?? (object)DBNull.Value);
                ...
                alunoTurmaBoletimId = result != null ? Convert.ToInt32(result) : null;
            }
