...
{
    public class ProfessorSqlServerRepository : BaseRepository, IProfessorRepository
    {
        public ProfessorSqlServerRepository(string connectionString) : base(connectionString)
        {
        }
        ...
        public int? Inserir(Professor professor)
        {
            ...
            using (var conn = new SqlConnection(ConnectionString))
            {
                ...
                professorId = result != null ? Convert.ToInt32(result) : null;
            }
