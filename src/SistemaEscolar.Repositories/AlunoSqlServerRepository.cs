...
{
    public class AlunoSqlServerRepository : BaseRepository, IAlunoRepository
    {
        public AlunoSqlServerRepository(string connectionString) : base(connectionString)
        {
        }
        ...
        public int? Inserir(Aluno aluno)
        {
            ...
            using (var conn = new SqlConnection(ConnectionString))
            {
                ...
                alunoId = result != null ? Convert.ToInt32(result) : null;
            }
