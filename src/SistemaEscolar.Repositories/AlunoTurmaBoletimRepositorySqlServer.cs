                ...
                using (var reader = cmd.ExecuteReader())
                {
                    if (reader.Read())
                    {
                        result = new AlunoTurmaBoletim
                        {
                            ...
                            NotaBim1Escrita = SqlServerRepositoryExtensions.GetDecimalOrNull(reader, "nota_bim1_escrita"),
                            NotaBim1Leitura = SqlServerRepositoryExtensions.GetDecimalOrNull(reader, "nota_bim1_leitura"),
                            NotaBim1Conversacao = SqlServerRepositoryExtensions.GetDecimalOrNull(reader, "nota_bim1_conversacao"),
                            NotaBim1Final = SqlServerRepositoryExtensions.GetDecimalOrNull(reader, "nota_bim1_final"),
                            NotaBim2Leitura = SqlServerRepositoryExtensions.GetDecimalOrNull(reader, "nota_bim2_leitura"),
                            NotaBim2Escrita = SqlServerRepositoryExtensions.GetDecimalOrNull(reader, "nota_bim2_escrita"),
                            NotaBim2Conversacao = SqlServerRepositoryExtensions.GetDecimalOrNull(reader, "nota_bim2_conversacao"),
                            NotaBim2Final = SqlServerRepositoryExtensions.GetDecimalOrNull(reader, "nota_bim2_final"),
                            NotaFinalSemestre = SqlServerRepositoryExtensions.GetDecimalOrNull(reader, "nota_final_semestre"),
                            FaltasSemestre = SqlServerRepositoryExtensions.GetInt32OrNull(reader, "faltas_semestre"),
