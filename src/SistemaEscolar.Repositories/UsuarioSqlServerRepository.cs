...
{
    public class UsuarioSqlServerRepository : BaseRepository, IUsuarioRepository
    {
        public UsuarioSqlServerRepository(string connectionString) : base(connectionString)
        {
        }
        ...
        public int? Inserir(Usuario usuario)
        {
            ...
            using (var conn = new SqlConnection(ConnectionString))
            {
                ...
                usuarioId = result != null ? Convert.ToInt32(result) : null;
            }
