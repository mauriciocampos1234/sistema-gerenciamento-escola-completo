...
{
    public class TurmaSqlServerRepository : BaseRepository, ITurmaRepository
    {
        public TurmaSqlServerRepository(string connectionString) : base(connectionString)
        {
        }
        ...
        public int? Inserir(Turma turma)
        {
            ...
            using (var conn = new SqlConnection(ConnectionString))
            {
                ...
                turmaId = result != null ? Convert.ToInt32(result) : null;
            }
